...
# for filename in os.listdir('./Tokenadd_sg1'):
#     if os.path.isfile(os.path.join('./Tokenadd_sg1', filename)):
#         with open(os.path.join('./Tokenadd_sg1', filename), 'r') as f:
#             for line in f:
#                 if line.strip():  # 跳过空行
#                     try:
...
# for filename in os.listdir('./Tokenadd_airdrop'):
#     if os.path.isfile(os.path.join('./Tokenadd_airdrop', filename)):
#         with open(os.path.join('./Tokenadd_airdrop', filename), 'r') as f:
#             for line in f:
...
# # 示例：统计多个文件夹的唯一ID总数
# folders_to_scan = ["./Tokenadd_sg1", "./Tokenadd_sg2"]  # 替换为你的实际文件夹路径
...
if __name__ == "__main__":
    main_folder = "./Tokenadd_sg1"  # 主文件夹路径
    backup_folder = "./Tokenadd_sg2"  # 备用文件夹路径
